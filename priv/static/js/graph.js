...
const update = source => {
  ...
  const orGate =
    "m 75,65 c  -1.4, -10, .6, -22 -15, -30 -15.6, 8, -13.4, 20, -15, 30, 0, 0 3, -8 15, -8 10, 0 15, 8 15, 8 z";
  const andGate =
    "m 45,50 0,15 30,0 0,-15  a15,15 .2 0,0 -15,-15 a15,15 .2 0,0 -15,15";
  const priorityGate =
    "m 45,50 0,15 30,0 0,-15  a15,15 .2 0,0 -15,-15 a15,15 .2 0,0 -15,15 m 0,10 30,0";
  const inhibitGate =
    "m 60,35 -15,6.340 0,17.3205 15,6.340  15,-6.340 0,-17.3205 z";
  const alarmGate =
  ...
  const atLeastGate =
    "m 75,65 c  -1.4,-10,.6,-22-15,-30  -15.6,8,-13.4,20,-15,30 m 0,0 0,10 30,0 0,-10 m-28,-7.5 27,0";
